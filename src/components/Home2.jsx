    ...
    <section id="home" className="home section">
      <div className="w-3/4 m-auto">
        <Grid container spacing={2}>
          <Grid item xs={8}>
            <Item>
              <span className="border-solid border-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 py-2 px-2.5 font-bold inline-block mb-4 text-lg text-center w-1/2 sm:text-lg">
